...
public class pipei_Dialog extends Dialog {
    ...
    void init(){
        ...
        findViewById(R.id.pipei_assure).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (listener != null) {
                    listener.onDialogResult("pipei");
                }
                dismiss();
            }
        });
    ...
    public pipei_Dialog(@NonNull Context context, int themeResId) {
        super(context, themeResId);


        setContentView(R.layout.pipei_dialog);
